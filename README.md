...
| Is your software’s architecture and design modular | 3 | Link to Github Folder |
...
| Does your software allow communications using open communications protocols? | 3 | Link to Github README indicating it's copying text |
...
| Does your documentation adhere to appropriate accessibility conventions or standards? | 3 | Link to Docs |
| Is your source code stored in a repository under revision control? | 3 | Link to github repo |
| Is each source code release a snapshot of the repository? | 0 | Link to whole repository |
| Are releases tagged in the repository? | 3 | Link to tags |
| Is there a branch of the repository that is always stable? (i.e. tests always pass, code always builds successfully) | 3 | Link to main branch |
| Do you back-up your repository? | 0 | Link to README |
| Do you provide publicly-available instructions for building your software from the source code? | 3 | Link to README | 
| Can you build, or package, your software using an automated tool? | 2| Link to README |
| Do you provide publicly-available instructions for deploying your software? | 3 | Link to README |
...
| Can you download dependencies using a dependency management tool or package manager? | 3 | Link to README indicating python versions |
...
| Do you have an automated test suite for your software? | 3 | Link to tests folder |
...
| Can users subscribe to notifications to changes to your source code repository? | 3 | Link to Github, by showing people can watch a website |
...
| Do you accept contributions (e.g. bug fixes, enhancements, documentation updates, tutorials) from people who are not part of your project? | 3 | Link to README |
| Do you have a contributions policy? | 3 | Link to Contributions.md |
| Is your contributions' policy publicly available? | 3 | Link to contributions.md |
...
| Does your website and documentation clearly state the licence of your software? | 3 | Link to README |
| Is your software released under an open source licence? | 3 | MIT link |
| Is your software released under an OSI-approved open-source licence? | 3 | MIT link |
...
| Does your website or documentation include a project roadmap (a list of project and development milestones for the next 3, 6 and 12 months)? | 1 | Just features |
...
| Do you make timely announcements of the deprecation of components, APIs, etc.? | 0 | Link to README |